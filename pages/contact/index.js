...
const Contact = () => {
  return(
    <div className="h-full backdrop-blur-xl bg-white/20">
    
      <div className="container z-50 mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full">
       {/* text& form*/}
       <div className="flex flex-col w-full max-w-[700px]">
        {/* text */}
          ...
          animate='show'
          exit='hidden'
          className="h2 text-center sm:mb-12">
